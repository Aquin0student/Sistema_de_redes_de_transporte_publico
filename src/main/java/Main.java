...
public class Main {
    public static void main(String[] args){
        ...
        //teste.printarArestas();

        Lercsv a = new Lercsv();
        //a.lerTempoParado("par_4_1", "4__1_____1_", "12:00:00");

        teste.buscaMenorCaminho("HOSPITAL INFANTA SOFIA", "PAVONES", "10:00:00");

        //System.out.println("Digite o nome da estacao que voce quer ter como origem (Exatamente igual esta no arquivo vertices.csv): ");
    }
}